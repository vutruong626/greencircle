                    ...
                    <div class="service-content">
                        <div class="row">
                            <div class="col-lg-4 col-md-4">
                                <div class="single-service">
                                    <div class="service-image">
                                        <img src="{{$common_data['hosts'].'/assets/img/icon/rocket.png'}}" alt="">
                                    </div>
                            ...
                            <div class="col-lg-4 col-md-4">
                                <div class="single-service">
                                    <div class="service-image">
                                        <img src="{{$common_data['hosts'].'/assets/img/icon/money.png'}}" alt="">
                                    </div>
                                    <div class="service-text">
                            ...
                            <div class="col-lg-4 col-md-4">
                                <div class="single-service">
                                    <div class="service-image">
                                        <img src="{{$common_data['hosts'].'/assets/img/icon/support.png'}}" alt="">
                                    </div>
                                    <div class="service-text">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-footer-widget">
                            <div class="footer-logo">
                                <a href="#"><img src="{{$common_data['hosts'].'/assets/img/logo/logo.png'}}" alt=""></a>
                            </div>
                            <p>Claritas est etiam processus dynamicus, qui sequitur mutationem consuetudium
                                lectorum.</p>
                            <div class="footer-text">
                                <span><i class="icon icon-Pointer"></i>Address : No 40 Baria Sreet 133/2, NewYork,
                                    USA.</span>
                        ...
                        <div class="single-footer-widget">
                            ...
                            <div class="instagram-image">
                                <div class="single-insta-img">
                                    <a href="#"><img src="{{$common_data['hosts'].'/assets/img/instagram/1.jpg'}}" alt=""></a>
                                </div>
                                <div class="single-insta-img">
                                    <a href="#"><img src="{{$common_data['hosts'].'/assets/img/instagram/2.jpg'}}" alt=""></a>
                                </div>
                                <div class="single-insta-img">
                                    <a href="#"><img src="{{$common_data['hosts'].'/assets/img/instagram/3.jpg'}}" alt=""></a>
                                </div>
                                <div class="single-insta-img">
                                    <a href="#"><img src="{{$common_data['hosts'].'/assets/img/instagram/4.jpg'}}" alt=""></a>
                                </div>
                                <div class="single-insta-img">
                                    <a href="#"><img src="{{$common_data['hosts'].'/assets/img/instagram/5.jpg'}}" alt=""></a>
                                </div>
                                <div class="single-insta-img">
                                    <a href="#"><img src="{{$common_data['hosts'].'/assets/img/instagram/6.jpg'}}" alt=""></a>
                                </div>
                                <div class="single-insta-img">
                                    <a href="#"><img src="{{$common_data['hosts'].'/assets/img/instagram/7.jpg'}}" alt=""></a>
                                </div>
                                <div class="single-insta-img">
                                    <a href="#"><img src="{{$common_data['hosts'].'/assets/img/instagram/8.jpg'}}" alt=""></a>
                                </div>
                            </div>
            ...
            <div class="row">
                <div class="col-lg-6 d-flex col-md-6">
                    <div class="footer-text-bottom">
                        <p>Copyright &copy; <a href="#">GreenCircle</a>. All Rights Reserved</p>
                    </div>
                </div>
